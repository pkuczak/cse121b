...
export function displayWordInfo(wordInfo, inputWord) {
    ...
    wordDiv.class = "word";
    wordDiv.innerHTML = `<br><h3>${inputWord}</h3>`;
    ...
    definePara.textContent = `Definition: ${wordInfo[0].meanings[0].definitions[0].definition}`;

    let examplePara = document.createElement("p")
    examplePara.class = "word-example";
    examplePara.textContent = `Example: ${wordInfo[0].meanings[0].definitions[0].example}`;
